    ...
    @php
        ...
        foreach (range(1, 5) as $i) {
            if (isset($slotArticles[$i])) {
                ...
                if ($i <= 4) {
                    $slotHtml[$i] = '<a href="' . $url . '" target="_blank" style="background:rgba(240,247,255,0.88);overflow:hidden;height:100%;display:flex;flex-direction:column;text-decoration:none;color:inherit;border-radius:4px">'
                        . $img
                        ...
                        . '<p style="font-size:9px;color:#444;margin:0;line-height:1.35;overflow:hidden">' . e($excerpt) . '</p>'
                        . '</div>'
                        . '<div style="padding:2px 6px 4px;text-align:right"><span style="font-size:9px;color:#0077be">Lire la suite →</span></div>'
                        . '</a>';
                } else {
                    $slotHtml[$i] = '<a href="' . $url . '" target="_blank" style="background:rgba(240,247,255,0.88);height:100%;display:flex;align-items:center;justify-content:center;padding:0 8px;text-decoration:none;border-radius:4px">'
