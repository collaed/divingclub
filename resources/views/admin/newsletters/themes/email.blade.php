...
<table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:{{ $colors['bg'] }}">
        ...
        <td style="padding:0">
            ...
            <tr>
                ...
                <td width="45" style="background-image:url('{{ $imgBase }}/row1-left.jpg');background-size:cover;background-position:center" valign="top">
                    <img src="{{ $imgBase }}/row1-left.jpg" width="45" style="display:block;width:45px" alt="Decoration">
                </td>
                @endif
                ...
                <td width="45" style="background-image:url('{{ $imgBase }}/row1-center.jpg');background-size:cover;background-position:center" valign="top">
                    <img src="{{ $imgBase }}/row1-center.jpg" width="45" style="display:block;width:45px" alt="Decoration">
                </td>
                @endif
                ...
                <td width="44" style="background-image:url('{{ $imgBase }}/row1-right.jpg');background-size:cover;background-position:center" valign="top">
                    <img src="{{ $imgBase }}/row1-right.jpg" width="44" style="display:block;width:44px" alt="Decoration">
                </td>
                @endif
            </tr>
            </table>
    ...
    <tr>
        <td style="padding:0;font-size:0;line-height:0">
            <img src="{{ $imgBase }}/h-separator.jpg" width="600" style="width:100%;max-width:600px;display:block;border:0" alt="Decoration">
        </td>
    </tr>
    @else
        ...
        <td style="padding:0">
            ...
            <tr>
                ...
                <td width="45" style="background-image:url('{{ $imgBase }}/row2-left.jpg');background-size:cover;background-position:center" valign="top">
                    <img src="{{ $imgBase }}/row2-left.jpg" width="45" style="display:block;width:45px" alt="Decoration">
                </td>
                @endif
                ...
                <td width="45" style="background-image:url('{{ $imgBase }}/row2-center.jpg');background-size:cover;background-position:center" valign="top">
                    <img src="{{ $imgBase }}/row2-center.jpg" width="45" style="display:block;width:45px" alt="Decoration">
                </td>
                @endif
                ...
                <td width="44" style="background-image:url('{{ $imgBase }}/row2-right.jpg');background-size:cover;background-position:center" valign="top">
                    <img src="{{ $imgBase }}/row2-right.jpg" width="44" style="display:block;width:44px" alt="Decoration">
                </td>
                @endif
            </tr>
            </table>
    ...
    <tr>
        <td style="padding:4px 10px;text-align:center;font-size:0;line-height:0">
            @foreach(collect($decorations)->take(8) as $dec)
                <img src="{{ $appUrl }}{{ $dec['src'] }}" width="32" height="32" style="display:inline-block;width:32px;height:32px;margin:2px 6px;opacity:0.35" alt="Decoration">
            @endforeach
        </td>
    </tr>
    @endif
    ...
    <tr>
        <td style="padding:0;font-size:0;line-height:0">
            <img src="{{ $imgBase }}/footer.jpg" width="600" style="width:100%;max-width:600px;display:block;border:0" alt="Decoration">
        </td>
    </tr>
