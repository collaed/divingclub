...
<div class="accordion" id="troubleAccordion">
    @foreach([
        ...
        'Bank reconciliation not matching' => '<ol><li>Communication string must match the format: <code>CLUB-YEAR-ID-NAME</code> (where CLUB is your Short Code from Settings)</li><li>Auto-match threshold is 60/100 — partial matches may not trigger</li><li>Try manual confirmation for edge cases</li></ol>',
