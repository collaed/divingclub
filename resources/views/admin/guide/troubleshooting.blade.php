...
<div class="accordion" id="troubleAccordion">
    @foreach([
        ...
        'Bank reconciliation not matching' => '<ol><li>Communication string must match the format: <code>CEP-YEAR-ID-NAME</code></li><li>Auto-match threshold is 60/100 — partial matches may not trigger</li><li>Try manual confirmation for edge cases</li></ol>',
