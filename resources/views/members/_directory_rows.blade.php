@foreach($members as $m)
    <tr>
        <td style="width:50px">
            <a href="{{ route('members.profile', $m) }}">
        ...
        <td data-label="{{ __('Name') }}"><a href="{{ route('members.profile', $m) }}" class="text-decoration-none text-body">{{ $m->detail?->first_name }} {{ $m->detail?->last_name }}</a></td>
