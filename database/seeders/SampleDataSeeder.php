...
class SampleDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $personas = [
            ...
            ['Dimitri', 'PAPADOPOULOS', 'dimitri.papa@sample.eu', 'M', 'Greece', 'N1', 20, 2024, $memberRole, $actif, 'el', '+352691200005', '2008-05-10'],
            ...
            ['Yuki', 'TANAKA', 'yuki.tanaka@sample.eu', 'F', 'Japan', 'N1', 10, 2025, $memberRole, $actif, 'en', '+352691200008', '2010-04-14'],
            ...
            ['Alina', 'POPESCU', 'alina.popescu@sample.eu', 'F', 'Romania', 'N1', 5, 2026, $memberRole, $actif, 'ro', '+352691200012', '2009-10-12'],
            ...
            ['Eva', 'SCHNEIDER', 'eva.schneider@sample.eu', 'F', 'Germany', 'N1', 15, 2025, $memberRole, $actif, 'de', '+352691200016', '2007-03-22'],
