...
class DiveGroupRuleSeeder extends Seeder
{
    public function run(): void
    {
        $rules = [
            ...
            ['name' => 'FFESSM PA-12 autonomous ≤12m', 'scope' => 'FFESSM', 'diver_condition' => 'PA12', 'dive_mode' => 'autonomous', 'min_leader_rank' => 20, 'leader_category' => 'diver', 'max_depth' => 12, 'max_group_size' => 3, 'description' => 'PA-12: autonomous to 12m in buddy pair/trio. Minimum age 16 (Art. A322-88).'],
            ['name' => 'FFESSM PA-20 autonomous ≤20m', 'scope' => 'FFESSM', 'diver_condition' => 'PA20', 'dive_mode' => 'autonomous', 'min_leader_rank' => 30, 'leader_category' => 'diver', 'max_depth' => 20, 'max_group_size' => 3, 'description' => 'PA-20 (Niveau 2 partial): autonomous to 20m. Minimum age 16 (Art. A322-88).'],
            ...
            ['name' => 'FFESSM PA-40 autonomous ≤40m', 'scope' => 'FFESSM', 'diver_condition' => 'PA40', 'dive_mode' => 'autonomous', 'min_leader_rank' => 50, 'leader_category' => 'diver', 'max_depth' => 40, 'max_group_size' => 3, 'description' => 'PA-40: autonomous to 40m in buddy pair/trio. Minimum age 17 (Art. A322-88).'],
            ...
            ['name' => 'FFESSM PA-60/N3 autonomous ≤60m', 'scope' => 'FFESSM', 'diver_condition' => 'PA60', 'dive_mode' => 'autonomous', 'min_leader_rank' => 60, 'leader_category' => 'diver', 'max_depth' => 60, 'max_group_size' => 3, 'description' => 'PA-60 (Niveau 3): autonomous to 60m. Minimum age 18 (Art. A322-89). Code du Sport maximum recreational depth on air.'],
