...
class EventAutomationRuleController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        $v = $request->validate([
            ...
            'trigger' => ['nullable', Rule::in([EventAutomationRule::TRIGGER_REGISTRATION_CLOSE, EventAutomationRule::TRIGGER_HOURS_BEFORE_EVENT])],
            'hours_before_event' => 'required_if:trigger,'.EventAutomationRule::TRIGGER_HOURS_BEFORE_EVENT.'|nullable|integer|min:1',
        ...
        EventAutomationRule::create([
            ...
            'trigger' => $v['trigger'] ?? EventAutomationRule::TRIGGER_REGISTRATION_CLOSE,
            'hours_before_event' => $v['hours_before_event'] ?? null,
