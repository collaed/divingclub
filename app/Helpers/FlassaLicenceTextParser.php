...
{
    /**
     * @return array{name: string, licence_number: string, year: string}|null null if the text doesn't look like a FLASSA licence.
     */
    public static function parse(string $text): ?array
    {
        ...
        return [
            'name' => trim($nameMatch[1]).' '.trim($nameMatch[2]),
            'licence_number' => $numberMatch[2],
            'year' => $numberMatch[1],
        ];
    }
}
